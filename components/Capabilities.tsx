...
export default function Capabilities() {
  ...
  return (
    <div ref={containerRef} style={{ height: `${rows.length * 100}vh` }}>
      ...
      >
        {/* Animated background gradient that shifts with active */}
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: `radial-gradient(ellipse 60% 70% at ${20 + active * 15}% 50%, color-mix(in oklab, var(--accent) 6%, transparent), transparent 70%)`,
              ...
              {rows.map((r, i) => (
                <div
                  ...
                  style={{
                    ...
                    transform: i === active ? "translateX(12px)" : "translateX(0)",
                ...
                >
                  <span
                    ...
                    style={{
                      fontSize: 22,
                      color: i === active ? "var(--accent)" : "var(--fg-mute)",
                  ...
                  <div>
                    <div
                      className="mono"
                      style={{ fontSize: 11, color: "var(--fg-mute)", letterSpacing: ".1em", textTransform: "uppercase", marginBottom: 4 }}
                    >
                      0{i + 1}
                    </div>
                    <div
                      style={{
                        ...
                        fontSize: 18,
                        fontWeight: 500,
                        color: i === active ? "var(--fg)" : "var(--fg-dim)",
                        transition: "color 0.4s ease",
                      }}
                    >
                      {r.ttl}
              ...
              {rows.map((r, i) => (
                <div
                  ...
                  style={{
                    ...
                    inset: i === 0 ? undefined : "48px",
                    opacity: i === active ? 1 : 0,
                    transform: i === active ? "translateY(0) scale(1)" : "translateY(20px) scale(0.98)",
                ...
                >
                  ...
                  <p style={{ color: "var(--fg-dim)", fontSize: 15, lineHeight: 1.6, marginBottom: 28 }}>
                    {r.desc}
                  </p>
                  ...
                  <a className="btn" href="#contact" style={{ marginTop: 28, display: "inline-flex", alignItems: "center", gap: 8 }}>
